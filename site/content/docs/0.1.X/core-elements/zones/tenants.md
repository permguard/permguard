...
In the [MagicFarmacia sample](/docs/0.1.x/getting-started/hands-on-examples#integration-use-case-pharmacy-branch-management), each pharmacy branch is a separate tenant, such as `matera-branch` or `pisa-branch`.
