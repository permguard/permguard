...
In the [MagicFarmacia sample](/docs/0.1.x/getting-started/hands-on-example/) the application enforces a permission check to determine whether the `platform-admin` actor can `view` a subscription.
{{< /callout >}}
