...
```bash
permguard authn identities create --zoneid 268786704340 --kind user --name nicolagallo --identitysourceid 1da1d9094501425085859c60429163c2
```
...
```bash
permguard authn identities create --zoneid 268786704340 --kind user --name nicolagallo --identitysourceid 1da1d9094501425085859c60429163c2 --output json
```
...
```bash
permguard authn identities list --zoneid 268786704340 --identitysourceid 1da1d9094501425085859c60429163c2
```
...
```bash
permguard authn identities list --zoneid 268786704340 --identitysourceid --output json
```
