...
Find and replace all the occurrence of `docs/0.0.x` with `docs/0.1.x` in the new version directory as well as in the go files.

Review the README.md file into the www directory.
