...
| `amzn-dogwood-language` | 1.0.0 | not declared | https://github.com/dogwood-policy/dogwood?rev=c6237c88099b3f492ecc5fcee42df06a19224b97 |
...
| `arrayvec` | 0.5.2 | MIT/Apache-2.0 | https://github.com/bluss/arrayvec |
| `arrayvec` | 0.7.8 | MIT OR Apache-2.0 | https://github.com/bluss/arrayvec |
| `ascii-canvas` | 4.0.0 | Apache-2.0/MIT | https://github.com/lalrpop/ascii-canvas |
...
| `cedar-policy` | 4.11.0 | Apache-2.0 | https://github.com/cedar-policy/cedar |
| `cedar-policy-core` | 4.11.0 | Apache-2.0 | https://github.com/cedar-policy/cedar |
| `cedar-policy-formatter` | 4.11.0 | Apache-2.0 | https://github.com/cedar-policy/cedar |
| `cedar-policy-mcp-schema-generator` | 0.6.0 | Apache-2.0 | https://github.com/cedar-policy/cedar-for-agents |
...
| `ena` | 0.14.4 | MIT OR Apache-2.0 | https://github.com/rust-lang/ena |
...
| `h2` | 0.4.18 | MIT | https://github.com/hyperium/h2 |
...
| `iso8601` | 0.6.5 | MIT | https://github.com/badboy/iso8601 |
...
| `mcp-tools-sdk` | 0.4.0 | Apache-2.0 | https://github.com/cedar-policy/cedar-for-agents |
...
| `opentelemetry` | 0.32.0 | Apache-2.0 | https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry |
| `opentelemetry-otlp` | 0.32.0 | Apache-2.0 | https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-otlp |
| `opentelemetry-proto` | 0.32.0 | Apache-2.0 | https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-proto |
| `opentelemetry_sdk` | 0.32.1 | Apache-2.0 | https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-sdk |
...
| `pretty` | 0.12.5 | MIT | https://github.com/Marwes/pretty.rs |
...
| `pulldown-cmark-to-cmark` | 22.0.0 | Apache-2.0 | https://github.com/Byron/pulldown-cmark-to-cmark |
...
| `spin` | 0.12.3 | MIT | https://codeberg.org/zesterer/spin |
...
| `term` | 1.2.1 | MIT OR Apache-2.0 | https://github.com/Stebalien/term |
...
| `tracing-opentelemetry` | 0.33.0 | MIT | https://github.com/tokio-rs/tracing-opentelemetry |
...
| `unicode-security` | 0.1.2 | MIT/Apache-2.0 | https://github.com/unicode-rs/unicode-security |
...
- `amzn-dogwood-language` 1.0.0 — https://github.com/dogwood-policy/dogwood?rev=c6237c88099b3f492ecc5fcee42df06a19224b97
