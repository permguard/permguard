...
build-release:
	...
	go build -o dist/server-all-in-one -trimpath -ldflags "-s -w -X 'github.com/permguard/permguard/internal/agents/cli.Version=$(VERSION)' -X 'github.com/permguard/permguard/internal/agents/cli.BuildTime=$(BUILD_TIME)' -X 'github.com/permguard/permguard/internal/agents/cli.GitCommit=$(GIT_COMMIT)'" ./cmd/server-all-in-one
	chmod +x dist/server-all-in-one
	go build -o dist/server-zap -trimpath -ldflags "-s -w -X 'github.com/permguard/permguard/internal/agents/cli.Version=$(VERSION)' -X 'github.com/permguard/permguard/internal/agents/cli.BuildTime=$(BUILD_TIME)' -X 'github.com/permguard/permguard/internal/agents/cli.GitCommit=$(GIT_COMMIT)'" ./cmd/server-zap
	chmod +x dist/server-zap
	go build -o dist/server-pap -trimpath -ldflags "-s -w -X 'github.com/permguard/permguard/internal/agents/cli.Version=$(VERSION)' -X 'github.com/permguard/permguard/internal/agents/cli.BuildTime=$(BUILD_TIME)' -X 'github.com/permguard/permguard/internal/agents/cli.GitCommit=$(GIT_COMMIT)'" ./cmd/server-pap
	chmod +x dist/server-pap
	go build -o dist/server-pip -trimpath -ldflags "-s -w -X 'github.com/permguard/permguard/internal/agents/cli.Version=$(VERSION)' -X 'github.com/permguard/permguard/internal/agents/cli.BuildTime=$(BUILD_TIME)' -X 'github.com/permguard/permguard/internal/agents/cli.GitCommit=$(GIT_COMMIT)'" ./cmd/server-pip
	chmod +x dist/server-pip
	go build -o dist/server-pdp -trimpath -ldflags "-s -w -X 'github.com/permguard/permguard/internal/agents/cli.Version=$(VERSION)' -X 'github.com/permguard/permguard/internal/agents/cli.BuildTime=$(BUILD_TIME)' -X 'github.com/permguard/permguard/internal/agents/cli.GitCommit=$(GIT_COMMIT)'" ./cmd/server-pdp
