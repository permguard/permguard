...
func (r *Repo) UpsertApplication(tx *sql.Tx, isCreate bool, application *Application) (*Application, error) {
	if application == nil {
...
func (r *Repo) DeleteApplication(tx *sql.Tx, applicationID int64) (*Application, error) {
...
func (r *Repo) FetchApplications(db *sqlx.DB, page int32, pageSize int32, filterID *int64, filterName *string) ([]Application, error) {
