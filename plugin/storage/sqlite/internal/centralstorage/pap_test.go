...
func createSQLitePAPCentralStorageWithMocks() (*SQLiteCentralStoragePAP, *storage.Context, *azmocks.MockSQLiteConnector, *azmocks.MockSqliteRepo, *azmocks.MockSqliteExecutor, *sqlx.DB, sqlmock.Sqlmock) {
