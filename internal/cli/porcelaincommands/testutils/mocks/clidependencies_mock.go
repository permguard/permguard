...
func (m *CliDependenciesMock) CreateGrpcZAPClient(zapEndpoint string, tlsCfg *grpctls.ClientConfig, collect func(string)) (clients.GrpcZAPClient, error) {
	args := m.Called(zapEndpoint, tlsCfg, collect)
...
func (m *CliDependenciesMock) CreateGrpcPAPClient(papEndpoint string, tlsCfg *grpctls.ClientConfig, collect func(string)) (clients.GrpcPAPClient, error) {
	args := m.Called(papEndpoint, tlsCfg, collect)
...
func (m *CliDependenciesMock) CreateGrpcPDPClient(pdpEndpoint string, tlsCfg *grpctls.ClientConfig, collect func(string)) (clients.GrpcPDPClient, error) {
	args := m.Called(pdpEndpoint, tlsCfg, collect)
