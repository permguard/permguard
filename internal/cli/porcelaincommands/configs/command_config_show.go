...
func runECommandForConfigShow(deps core.DependenciesProvider, cmd *cobra.Command, v *viper.Viper) error {
...
func createCommandForConfigShow(deps core.DependenciesProvider, v *viper.Viper) *cobra.Command {
