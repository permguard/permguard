...
func TestCliZonesCreateWithError(t *testing.T) {
	...
	for _, test := range tests {
		args := []string{"zones", "create", "mycorporate", "--output", test.OutputType}
		outputs := []string{""}
		...
		zapClient.On("CreateZone", mock.Anything).Return(nil, errors.New("operation error"))
...
func TestCliZonesCreateWithSuccess(t *testing.T) {
	...
	for _, outputType := range tests {
		args := []string{"zones", "create", "mycorporate", "--output", outputType}
		outputs := []string{""}
