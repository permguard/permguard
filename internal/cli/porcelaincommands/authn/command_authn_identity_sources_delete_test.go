...
func TestDeleteCommandForIdentitySourcesDelete(t *testing.T) {
	...
	testutils.BaseCommandTest(t, createCommandForIdentitySourceDelete, args, false, outputs)
}
...
func TestCliIdentitySourcesDeleteWithError(t *testing.T) {
	...
	for _, test := range tests {
		...
		zapClient.On("DeleteIdentitySource", mock.Anything, mock.Anything).Return(nil, errors.New("operation error"))
...
func TestCliIdentitySourcesDeleteWithSuccess(t *testing.T) {
	...
	for _, outputType := range tests {
		...
		if outputType == "terminal" {
			...
			outputPrinter["identity_sources"] = []*zap.IdentitySource{identitysource}
		}
