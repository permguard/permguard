...
func TestCreateCommandForIdentitySourcesCreate(t *testing.T) {
	...
	testutils.BaseCommandTest(t, createCommandForIdentitySourceCreate, args, false, outputs)
}
...
func TestCliIdentitySourcesCreateWithError(t *testing.T) {
	...
	for _, test := range tests {
		...
		zapClient.On("CreateIdentitySource", mock.Anything, mock.Anything).Return(nil, errors.New("operation error"))
...
func TestCliIdentitySourcesCreateWithSuccess(t *testing.T) {
	...
	for _, outputType := range tests {
		...
		zapClient.On("CreateIdentitySource", mock.Anything, mock.Anything).Return(identitysource, nil)
