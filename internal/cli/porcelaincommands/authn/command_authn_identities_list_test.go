...
func TestCliIdentitiesListWithError(t *testing.T) {
	...
	for _, test := range tests {
		...
		zapClient.On("FetchIdentitiesBy", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return(nil, cerrors.ErrClientParameter)
