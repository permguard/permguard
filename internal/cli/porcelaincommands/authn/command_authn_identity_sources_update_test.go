...
func TestUpdateCommandForIdentitySourcesUpdate(t *testing.T) {
	...
	testutils.BaseCommandTest(t, createCommandForIdentitySourceUpdate, args, false, outputs)
}
...
func TestCliIdentitySourcesUpdateWithError(t *testing.T) {
	...
	for _, test := range tests {
		args := []string{"identitysources", "update", "--identitysource-id", "c3160a533ab24fbcb1eab7a09fd85f36", "--output", test.OutputType}
		outputs := []string{""}
		...
		zapClient.On("UpdateIdentitySource", mock.Anything).Return(nil, cerrors.ErrClientParameter)
...
func TestCliIdentitySourcesUpdateWithSuccess(t *testing.T) {
	...
	for _, outputType := range tests {
		args := []string{"identitysources", "update", "--identitysource-id", "c3160a533ab24fbcb1eab7a09fd85f36", "--output", outputType}
		outputs := []string{""}
		...
		zapClient.On("UpdateIdentitySource", mock.Anything).Return(identitysource, nil)
