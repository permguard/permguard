...
func TestListCommandForIdentitySourcesList(t *testing.T) {
	...
	testutils.BaseCommandTest(t, createCommandForIdentitySourceList, args, false, outputs)
}
...
func TestCliIdentitySourcesListWithError(t *testing.T) {
	...
	for _, test := range tests {
		args := []string{"identitysources", "list", "--identitysource-id", "c3160a533ab24fbcb1eab7a09fd85f36", "--output", test.OutputType}
		outputs := []string{""}
		...
		zapClient.On("FetchIdentitySourcesBy", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return(nil, errors.New("operation error"))
...
func TestCliIdentitySourcesListWithSuccess(t *testing.T) {
	...
	for _, outputType := range tests {
		args := []string{"identitysources", "list", "--identitysource-id", "c3160a533ab24fbcb1eab7a09fd85f36", "--output", outputType}
		outputs := []string{""}
		...
		zapClient.On("FetchIdentitySourcesBy", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return(identitysources, nil)
