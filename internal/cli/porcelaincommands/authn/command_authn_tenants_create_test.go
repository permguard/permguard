...
func TestCreateCommandForTenantsCreate(t *testing.T) {
	...
	testutils.BaseCommandTest(t, createCommandForTenantCreate, args, false, outputs)
}
...
func TestCliTenantsCreateWithError(t *testing.T) {
	...
	for _, test := range tests {
		...
		zapClient.On("CreateTenant", mock.Anything, mock.Anything).Return(nil, errors.New("operation error"))
