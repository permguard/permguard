...
func TestDeleteCommandForLedgersDelete(t *testing.T) {
	...
	testutils.BaseCommandTest(t, createCommandForLedgerDelete, args, false, outputs)
}
...
func TestCliLedgersDeleteWithError(t *testing.T) {
	...
	for _, test := range tests {
		args := []string{"ledgers", "delete", "--ledger-id", "c3160a533ab24fbcb1eab7a09fd85f36", "--output", test.OutputType}
		outputs := []string{""}
		...
		papClient.On("DeleteLedger", mock.Anything, mock.Anything).Return(nil, errors.New("operation error"))
...
func TestCliLedgersDeleteWithSuccess(t *testing.T) {
	...
	for _, outputType := range tests {
		args := []string{"ledgers", "delete", "--ledger-id", "c3160a533ab24fbcb1eab7a09fd85f36", "--output", outputType}
		outputs := []string{""}
