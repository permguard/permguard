...
func runECommandForCreateLedger(deps core.DependenciesProvider, cmd *cobra.Command, v *viper.Viper) error {
...
func createCommandForLedgerCreate(deps core.DependenciesProvider, v *viper.Viper) *cobra.Command {
