...
func runECommandForPlanWorkspace(deps core.DependenciesProvider, cmd *cobra.Command, v *viper.Viper) error {
...
func CreateCommandForWorkspacePlan(deps core.DependenciesProvider, v *viper.Viper) *cobra.Command {
