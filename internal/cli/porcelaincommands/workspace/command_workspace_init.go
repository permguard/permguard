...
func runECommandForInitWorkspace(deps core.DependenciesProvider, cmd *cobra.Command, v *viper.Viper) error {
...
func CreateCommandForWorkspaceInit(deps core.DependenciesProvider, v *viper.Viper) *cobra.Command {
